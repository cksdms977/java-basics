...
public class _02_Output {
    public static void main(String[] args) {
        //System.out.format(); 둘다 써도 됨
        //System.out.printf("");; 둘다 써도됨
        System.out.println("----------- 정수 -----------");
        // 예 : System.out.printf("포매, 값1, 값2, 값3, ....");
        System.out.printf("%d%n", 1); // 정수값을 출력하고난후 줄바꿈을 하는것
        System.out.printf("%d %d %d%n", 1, 2, 3); // 1 2 3
        System.out.printf("%d%n", 1234); // 1234
        System.out.printf("%7d%n", 1234); // 6자리의 공간을 확보하고 나서 1234 출력
        System.out.printf("%06d%n", 1234); // 001234 (6자리 공간 확보 후 1234 출력하는데 빈 공간은 0 으로 채움)
        System.out.printf("%6d%n", -1234); // _-1234
        System.out.printf("%+6dn", 1234); // _+1234 (항상 기호 표시 )
        ...
        System.out.printf("%f%n", Math.PI); // 3.131593 (일반 출력)
        System.out.printf("%.2f", Math.PI); // 3.14 (소수점 둘째자리)
        System.out.printf("%6.2f%n", Math.PI); // __3.14 (6자리 공간 확보하고 수수점 둘째자리)
        ...
        System.out.println("서태웅 " + 100 + "" + 100 + "" + 100.0); // 서테웅 1000 100 100.0
        ...
        System.out.println("ABCDEFG"); // 한글이랑 영어랑 띄어쓰기 공간크기가 다름
